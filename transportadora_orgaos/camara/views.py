...
def camara_info(request, camara_id, template_name='camara_info.html'):
	...
	headers = {
		...
		'authorization': "JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1MDczMDIxNzAs" +"Im5iZiI6MTUwNzMwMjE3MCwiaWRlbnRpdHkiOjEsImV4cCI6MTUwNzMwMjQ3MH0.8e5Dgf79L4bIUGHdwX"
		+"--NgkSWzCz96UFuqvBKZ-jk3g"
    }

	camara_reports = requests.request("GET", url, headers=headers).json()
